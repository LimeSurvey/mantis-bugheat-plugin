...
To activate it, manually create an additional field called 'Bug heat' in the field settings and activate it for the projects you want the bug heat to display for.
